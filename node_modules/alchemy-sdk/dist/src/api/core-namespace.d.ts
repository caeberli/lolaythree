...
export declare class CoreNamespace {
     ...
     * @public
     */
    getTokenBalances(address: string): Promise<TokenBalancesResponseErc20>;
    /**
     ...
     * @public
     */
    getTokenBalances(address: string, options: TokenBalancesOptionsErc20): Promise<TokenBalancesResponseErc20>;
    /**
     ...
     * @public
     */
    getTokenBalances(address: string, options: TokenBalancesOptionsDefaultTokens): Promise<TokenBalancesResponse>;
    /**
