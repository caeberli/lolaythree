...
var index = require('./index-d7d4b3f7.js');
var SturdyWebSocket = require('sturdy-websocket');
var bignumber = require('@ethersproject/bignumber');
var networks = require('@ethersproject/networks');
var providers = require('@ethersproject/providers');
var alchemyProvider = require('./alchemy-provider-c68a92ac.js');
require('./api/utils');
require('axios');
...
function getAlchemyEventTag(event) {
    ...
    if (event.method === index.AlchemySubscription.PENDING_TRANSACTIONS) {
        return serializePendingTransactionsEvent(event);
    }
    else if (event.method === index.AlchemySubscription.MINED_TRANSACTIONS) {
...
function verifyAlchemyEventName(eventName) {
    if (!Object.values(index.AlchemySubscription).includes(eventName.method)) {
        throw new Error(`Invalid method name ${eventName.method}. Accepted method names: ${Object.values(index.AlchemySubscription)}`);
    }
}
/**
...
//# sourceMappingURL=alchemy-websocket-provider-10cfcf5f.js.map
